      ...
      <div className="p-6">
        <div className="mb-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="mb-4">
              <span className="font-medium">Variáveis de Decisão:</span>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <div
                        ...
                        style={{
                          backgroundColor: v.cor || CORES[index % CORES.length],
                        }}
                      ></div>
                  ...
                  {variaveis.map((variavel, idx) => (
                    <div key={idx} className="flex flex-col">
                      <div className="flex items-center mb-1">
                        ...
                        ></div>
                        <label className="text-gray-700 w-1/3 font-medium">
                          {variavel.nome}: {variavel.descricao}
                        </label>
                        <input
                          type="range"
                          min="0"
                      ...
                      {variavel.detalhes && (
                        <div className="ml-5 text-xs text-gray-600 mb-2">
                          {variavel.detalhes}
                        </div>
                      )}
                    </div>
                ...
                {resultadoOtimo && (
                  <div className="mt-4 p-3 bg-green-50 border border-green-100 rounded-lg">
                    <p className="text-sm font-medium text-green-800">
                      Valor ótimo:{" "}
                      {resultadoOtimo.valorFuncaoObjetivo.toFixed(1)}
                    </p>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {restricoes.map((restricao, idx) => {
                    ...
                    const tolerancia = 0.1; // Margem de tolerância para evitar falsos positivos
                    const atende =
                      restricao.tipo === "<="
                        ? valorCalculado <= restricao.valorLimite + tolerancia
                        : restricao.tipo === ">="
                        ? valorCalculado >= restricao.valorLimite - tolerancia
